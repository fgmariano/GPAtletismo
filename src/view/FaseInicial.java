...
public class FaseInicial extends JFrame {
	...
	public FaseInicial(int prova, String nome) {
		setTitle(nome + " - Fase Inicial");
...
//		table.setModel(model);
	...
	public boolean preencherTabela(int prova) {
		int row = 0;
		lista = dao.listarResultados(prova+1, 1);
		if (lista.isEmpty()) {
